...
class DucoCobot:
    ...
    def movej(self, joints_list, v, a, r, block, op=op_, def_acc = True):
        return self.client.movej(joints_list, v, a, r, block, op, def_acc)

    def movej2(self, joints_list, v, a, r, block, op=op_, def_acc = True):
        return self.client.movej2(joints_list, v, a, r, block, op, def_acc)

    def movej_pose(self, p, v, a, r, q_near, tool, wobj, block, op=op_, def_acc = True):
        return self.client.movej_pose(p, v, a, r, q_near, tool, wobj, block, op, def_acc)

    def movej_pose2(self, p, v, a, r, q_near, tool, wobj, block, op=op_, def_acc = True):
        return self.client.movej_pose2(p, v, a, r, q_near, tool, wobj, block, op, def_acc)

    def movel(self, p, v, a, r, q_near, tool, wobj, block, op=op_, def_acc = True):
        return self.client.movel(p, v, a, r, q_near, tool, wobj, block, op, def_acc)

    def movec(self, p1, p2, v, a, r, mode, q_near, tool, wobj, block, op=op_, def_acc = True):
        return self.client.movec(p1, p2, v, a, r, mode, q_near, tool, wobj, block, op, def_acc)
    
    def move_circle(self, p1, p2, v, a, r, mode, q_near, tool, wobj, block, op=op_, def_acc = True):
        return self.client.move_circle(p1, p2, v, a, r, mode, q_near, tool, wobj, block, op, def_acc)

    def tcp_move(self, pose_offset, v, a, r, tool, block, op=op_, def_acc = True):
        return self.client.tcp_move(pose_offset, v, a, r, tool, block, op, def_acc)

    def tcp_move_2p(self, p1, p2, v, a, r, tool, wobj, block, op=op_, def_acc = True):
        return self.client.tcp_move_2p(p1, p2, v, a, r, tool, wobj, block, op, def_acc)

    def spline(self, pose_list, v, a, tool, wobj, block, op=op_, r=0, def_acc = True):
    ...
    def move_spiral(self, p1, p2, rev, len, r, mode, v, a, q_near, tool, wobj, block, op=op_, def_acc = True):
    ...
    def movej2_eaxis(self, joints_list, v, a, rad, scheme_name, epose, eaxis_v, block, op = op_, def_acc = True):
        return self.client.movej2_eaxis(joints_list, v, a, rad, scheme_name, epose, eaxis_v, block, op, def_acc)

    def movej2_pose_eaxis(self, p, v, a, rad, qnear, tool, wobj, scheme_name, epose, eaxis_v, block, op = op_, def_acc = True):
        return self.client.movej2_pose_eaxis(p, v, a, rad, qnear, tool, wobj, scheme_name, epose, eaxis_v, block, op, def_acc)

    def movel_eaxis(self, p, v, a, rad, qnear, tool, wobj, scheme_name, epose, eaxis_v, block, op = op_, def_acc = True):
        return self.client.movel_eaxis(p, v, a, rad, qnear, tool, wobj, scheme_name, epose, eaxis_v, block, op, def_acc)

    def movec_eaxis(self, p1, p2, v, a, rad, qnear, tool, wobj, scheme_name, epose, eaxis_v, block, op = op_, def_acc = True):
